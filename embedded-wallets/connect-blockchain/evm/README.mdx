...
You can check out the following guides we've written for certain blockchains. We have covered a wide variety of EVM Chains, if anything is missing, you can add directly on the [Dashboard](https://docs.metamask.io/embedded-wallets/connect-blockchain/evm/#dashboard-configuration).
